 ...
 */
final class Version20211022102427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student ADD classroom_id INT DEFAULT NULL, DROP id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student ADD id INT AUTO_INCREMENT NOT NULL, DROP classroom_id, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    }
}
